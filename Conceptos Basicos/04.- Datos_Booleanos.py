...
print(Sensor1) #Imprime solo el estado de la variable

#Imprime texto y concatena el estado de las variables
print("Estado del Sensor 1 " + str(Sensor1))

print("Estado del Sensor 2 " + str(Sensor2))
